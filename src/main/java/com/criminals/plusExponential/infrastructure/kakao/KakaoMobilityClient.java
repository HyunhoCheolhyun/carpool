...
public class KakaoMobilityClient {
    ...
    public Map<String, Object> getResponse(Coordinate point1, Coordinate point2, Coordinate point3) {
        ...
        destination.put("x", String.valueOf(point3.getLng()));
        destination.put("y", String.valueOf(point3.getLat()));
